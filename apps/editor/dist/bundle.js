(() => {
    ...
    */
    insertText(text, from, to) {
      ...
      if (from == null) {
        ...
        this.replaceRangeWith(from, to, schema2.text(text, marks));
  ...
  // ../../node_modules/.pnpm/prosemirror-view@1.42.3/node_modules/prosemirror-view/dist/index.js
  ...
  var code = "{\n  x\n  y\n\n}";
  var doc3 = schema.node("doc", null, [
    schema.node("paragraph", null, [schema.text("Code")]),
    schema.node("code_block", null, [schema.text(code)])
  ]);
  var caretBar = document.body.appendChild(document.createElement("div"));
  ...
  window.view = new EditorView(document.querySelector("#editor"), {
    state: EditorState.create({ doc: doc3, plugins: [virtualCaret] })
  });
})();
